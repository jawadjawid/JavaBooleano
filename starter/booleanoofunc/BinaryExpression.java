...
public abstract class BinaryExpression implements BooleanExpression {
  ...
  public BinaryExpression(BinaryOperator<Boolean> operator, booleanoofunc.BooleanExpression left, booleanoofunc.BooleanExpression right,
  ...
  public booleanoofunc.BooleanExpression simplify(Map<String, Boolean> context) {
    return simplifier.apply(this.left.simplify(context), this.right.simplify(context)).simplify(context);
  }
