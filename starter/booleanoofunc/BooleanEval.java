...
public class BooleanEval {
  ...
  static Map<String, Boolean> context =
  ...
  static Map<String, Boolean> context2 =
      Collections.unmodifiableMap(
          new HashMap<String, Boolean>() {
            {
              put("c", false);
  ...
  private static void demoFunctional() {
    ...
    System.out.println("evaluateAll returns " + BooleanExpressions.evaluateAll(list, context));
    System.out.println(
        "evaluateAndReduce returns " + BooleanExpressions.evaluateAndReduce(list, context));
    System.out.println(
        "evaluateAndMapRedule returns " + BooleanExpressions.evaluateAndMapReduce(list, context));
    System.out.println(
        "evaluateOrMapRedule returns " + BooleanExpressions.evaluateOrMapReduce(list, context));
    System.out.println(
        "evaluateMapReduce with and/true returns "
            + BooleanExpressions.evaluateMapReduce((x, y) -> x && y, true, list, context));
    System.out.println(
        "evaluateMapReduce with or/false returns "
